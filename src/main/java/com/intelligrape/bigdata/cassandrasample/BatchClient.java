...
public class BatchClient {
	...
	private Logger logger = Logger.getLogger(BatchClient.class);
	...
	public void insertData() {
		...
		PreparedStatement preparedStatement = session.prepare("BEGIN BATCH "+
		        "insert into meetup_db.departments (dep_id, dep_name, dep_head, dep_head_email) values (?, ?, ?, ?); "+
				"insert into meetup_db.departments (dep_id, dep_name, dep_head, dep_head_email) values (?, ?, ?, ?);"+
		        "APPLY BATCH");
		
		session.execute(preparedStatement.bind(1, "hr", "charu", "charu@ig.com", 2, "admin", "deepak handuja", "deepak@ig.com"));
